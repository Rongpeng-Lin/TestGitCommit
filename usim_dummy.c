...
#ifdef _FIRST_CALL_TEST_
UINT8 ucRead6f07[13] = {2,0x90,0x00,9,0x08,0x49,0x06,0x00,0x10,0x32,0x54,0x06,0x36};
#else
#ifdef START_MODE_ST
...
#ifdef _FIRST_CALL_TEST_
UINT8 ucRead6fd9[16] = {2,0x90,0x00,12,0x64,0xf0,0x00,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
#else
 ...
 UINT8 ucSel6fe8_noFast_noMinum[41] = {2,0x90,0x00,37,0x62,0x23,0x82,0x02,0x41,0x21,0x83,0x02,0x6f,0x38,0xa5,0x06,0x80,0x01,0x31,0xc0,0x01,0x00,0x8a,0x01,0x05,0x8b,0x03,0x6f,0x06,0x03,0x80,0x02,0x00,0x28,0x81,0x02,0x00,0x16,0x88,0x01,0x20};
 UINT8 ucRead6fe8_noFast_noMinum[44] = {2,0x90,0x00,40,0x80,0x01,0x00,0x81,0x01,0x00,0x82,0x01,0x00,0x84,0x01,0x00,0x85,0x01,0x00,0x86,0x01,0x00,0x87,0x01,0x00,0x89,0x01,0x00,0x8A,0x01,0xAC,0x8B,0x01,0x00,0x8C,0x02,0x00,0x00,0x8D,0x01,0x01,0x8E,0x01,0x00};
 
 UINT8 ucSel6fe8_noFast[41] = {2,0x90,0x00,37,0x62,0x23,0x82,0x02,0x41,0x21,0x83,0x02,0x6f,0x38,0xa5,0x06,0x80,0x01,0x31,0xc0,0x01,0x00,0x8a,0x01,0x05,0x8b,0x03,0x6f,0x06,0x03,0x80,0x02,0x00,0x2B,0x81,0x02,0x00,0x16,0x88,0x01,0x20};
 UINT8 ucRead6fe8_noFast[47] = {2,0x90,0x00,43,0x80,0x01,0x00,0x81,0x01,0x00,0x82,0x01,0x00,0x83,0x01,0x00,0x84,0x01,0x00,0x85,0x01,0x00,0x86,0x01,0x00,0x87,0x01,0x00,0x89,0x01,0x00,0x8A,0x01,0xAC,0x8B,0x01,0x00,0x8C,0x02,0x00,0x00,0x8D,0x01,0x01,0x8E,0x01,0x00};
...
UINT8 GetRTOSIndex()
{
    ...
    else if((0 == strcmp((const char*)ScriptName, "NASMM_PT_08_04_01_02")))
    {
        ucIndex = 6;
    }
    else if((0 == strcmp((const char*)ScriptName, "NASMM_PT_08_04_01_03")))
    {
        ucIndex = 7;
    }
    else
...
const UINT8 ucEfidCaseNo_tbl[][25] =
{
    ...
    /*00*/ { 0x00,  0x00,  0x00,  0x00,  0x00,  0x00, 0x00, 0x00, 0x00},//0
    /*01*/ { 0x01,  0x1A,  0x01,  0x01,  0x01,  0x01, 0x01, 0x01, 0x01},//0x2f00,
    /*02*/ { 0x02,  0x02,  0x02,  0x02,  0x02,  0x02, 0x02, 0x02, 0x02},//0x2f08,
    /*03*/ { 0x03,  0x03,  0x03,  0x03,  0x03,  0x03, 0x03, 0x03, 0x03},//0x2fe2,
    /*04*/ { 0x04,  0x04,  0x04,  0x04,  0x04,  0x04, 0x04, 0x04, 0x04},//0x6f07,
    /*05*/ { 0x05,  0x05,  0x05,  0x05,  0x05,  0x05, 0x05, 0x05, 0x05},//0x6f09,
    /*06*/ { 0x06,  0x06,  0x06,  0x06,  0x06,  0x06, 0x06, 0x06, 0x06},//0x6f31,
    /*07*/ { 0x07,  0x07,  0x07,  0x07,  0x07,  0x25, 0x26, 0x07, 0x07},//0x6f38,
    /*08*/ { 0x08,  0x08,  0x08,  0x08,  0x08,  0x08, 0x08, 0x08, 0x08},//0x6f56,
    /*09*/ { 0x09,  0x09,  0x09,  0x1D,  0x09,  0x09, 0x09, 0x09, 0x09},//0x6f60,
    /*10*/ { 0x0A,  0x0A,  0x0A,  0x1E,  0x0A,  0x0A, 0x0A, 0x0A, 0x0A},//0x6f61,
    /*11*/ { 0x0B,  0x0B,  0x0B,  0x0B,  0x20,  0x20, 0x0B, 0x0B, 0x0B},//0x6f78,
    /*12*/ { 0x0C,  0x0C,  0x0C,  0x0C,  0x0C,  0x0C, 0x0C, 0x0C, 0x0C},//0x6f7b,
    /*13*/ { 0x0D,  0x0D,  0x0D,  0x0D,  0x0D,  0x0D, 0x0D, 0x0D, 0x0D},//0x6fad,
    /*14*/ { 0x0E,  0x0E,  0x0E,  0x1F,  0x0E,  0x0E, 0x0E, 0x0E, 0x0E},//0x6fd9,
    /*15*/ { 0x0F,  0x0F,  0x0F,  0x0F,  0x0F,  0x0F, 0x0F, 0x0F, 0x0F},//0x6fdb,
    /*16*/ { 0x10,  0x10,  0x10,  0x10,  0x10,  0x10, 0x10, 0x10, 0x10},//0x6fdc,
    /*17*/ { 0x11,  0x11,  0x11,  0x11,  0x11,  0x26, 0x27, 0x28, 0x11},//0x6fe8,
    /*18*/ { 0x12,  0x12,  0x12,  0x12,  0x12,  0x12, 0x12, 0x12, 0x12},//0x6fec,
    /*19*/ { 0x13,  0x13,  0x1C,  0x13,  0x13,  0x13, 0x13, 0x13, 0x13},//0x4f01,
    /*20*/ { 0x14,  0x14,  0x1B,  0x14,  0x14,  0x14, 0x14, 0x14, 0x14},//0x4f03,
    /*21*/ { 0x15,  0x15,  0x15,  0x15,  0x15,  0x15, 0x15, 0x15, 0x15},//0x4f05,
    /*22*/ { 0x16,  0x16,  0x16,  0x16,  0x16,  0x16, 0x16, 0x16, 0x16},//0x4f06,
    /*23*/ { 0x17,  0x17,  0x17,  0x17,  0x17,  0x17, 0x17, 0x17, 0x17},//0x4f07,
    /*24*/ { 0x18,  0x18,  0x18,  0x18,  0x18,  0x18, 0x18, 0x18, 0x18},//0x4f0a,
    /*25*/ { 0x21,  0x21,  0x21,  0x21,  0x21,  0x21, 0x21, 0x21, 0x21},//0x6f42,
    /*26*/ { 0x22,  0x22,  0x22,  0x22,  0x22,  0x22, 0x22, 0x22, 0x22},//0x6f43,
    /*27*/ { 0x23,  0x23,  0x23,  0x23,  0x23,  0x23, 0x23, 0x23, 0x23},//0x6f3c,
    /*28*/ { 0x24,  0x24,  0x24,  0x24,  0x24,  0x24, 0x24, 0x24, 0x24},//0x6f47,
};
...
UINT8 *const pUSIMRead_tbl[] =
{
    ...
    /*0x27*/ ucRead6fe8_noFast_noMinum,
    /*0x28*/ ucRead6fe8_noFast
};
UINT16 const ausUSIMReadLen[] =
{
    ...
    /*0x27*/ sizeof(ucRead6fe8_noFast_noMinum),
    /*0x28*/ sizeof(ucRead6fe8_noFast)
};
...
/*
    ...
    else
    {
        ...
        {
            ulEfidRec = 0x6fe8;
            if (0 == strcmp((const char*)ScriptName,"NASMM_PT_08_04_01_02"))
            {
                *output_len = sizeof(ucSel6fe8_noFast_noMinum);
                OSAdpMemCpy(output_str,ucSel6fe8_noFast_noMinum,*output_len, MEM_OPERATE_0_CHECK);
            }
            else if (0 == strcmp((const char*)ScriptName,"NASMM_PT_08_04_01_03"))
            {
                *output_len = sizeof(ucSel6fe8_noFast);
                OSAdpMemCpy(output_str,ucSel6fe8_noFast,*output_len, MEM_OPERATE_0_CHECK);
            }
            else
            {
